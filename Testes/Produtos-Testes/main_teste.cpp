...
#include "../../Produto_classe_pai/Alimentos-hpp/PastilhaTosse.hpp"
#include "../../Produto_classe_pai/Cosmeticos-hpp/Condicionador.hpp"
#include "../../Produto_classe_pai/Cosmeticos-hpp/Shampoo.hpp"
...
TEST_CASE("Teste de Alimento - Pastilha") 
{
    ...
    REQUIRE(pastilha->Produto::getPrecoProduto() == 15.00f);
...
TEST_CASE("Teste de Cosmetico - Condicionador") 
{
    ...
    REQUIRE(clearman->Produto::getPrecoProduto() == 17.50f);
...
TEST_CASE("Teste de Cosmetico - Shampoo") 
{
    ...
    REQUIRE(shampoozao->Produto::getPrecoProduto() == 15.85f);
...
{
    Cosmetico* clearman = new Condicionador("A01523", "COND cabelos", 25, 17.5f);
    Cosmetico* shampoozao = new Shampoo("S01523", "Shampoo ensaboado", 13, 15.85f);
